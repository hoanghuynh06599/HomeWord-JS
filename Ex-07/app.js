...
const handleRenderWomenProducts = () => {
    $("#women").innerHTML = ""
...
const handleAddProduct = () => {
    ...
    if (productType === 'women') {
        const currIndex = womenItems.length + 1
        newProduct.id = currIndex
        womenItems.push(newProduct)
        handleRenderWomenProducts()
    } else if (productType === 'men') {
        const currIndex = menItems.length + 1
        newProduct.id = currIndex
        menItems.push(newProduct)
        handleRenderMenProducts()
    } else {
